...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		extent.setSystemInfo("Host Name", "IBM VM Machine");
		extent.setSystemInfo("Environment", "Production");
		extent.setSystemInfo("User Name", "Rajesh Singh");
		extent.setSystemInfo("AutomationID", "IBM_101");
		extent.setSystemInfo("AutomationBatchID", "IBM Batch2");
		
		htmlReporter.config().setDocumentTitle("IBM - Functional Automation/API Report");
		// Name of the report
		htmlReporter.config().setReportName("IBM Regression Batch 2 Report");
		// Dark Theme
	...
	@Test
	public void verifyGoogleApplicationTitle() {
	...
	public void verifyLogo() {
		...
		boolean img = driver.findElement(By.xpath("//img[@id='askdjhakshdk']")).isDisplayed();
...
//			
//			logger.log(Status.FAIL,result.getHost());
//			logger.log(Status.FAIL,
...
//			// String Scrnshot=TakeScreenshot.captuerScreenshot(driver,"TestCaseFailed");
			...
			logger.log(Status.PASS, "test case get pass**********");
			logger.log(Status.FAIL, result.getName());
			logger.log(Status.FAIL, result.getThrowable());
			
			logger.log(Status.FAIL,
					MarkupHelper.createLabel(result.getName() + " - Test Case Failed", ExtentColor.INDIGO));
